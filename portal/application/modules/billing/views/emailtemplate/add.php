...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php echo base_url('Billing/emailtemplate') ?>"><button class="btn btn-primary" type="button">Back to Customer Listing Page</button></a> </li>
        </ul>
    </div>
                        ...
                        <form action="<?php echo base_url(); ?>Billing/emailtemplateadd" method="post" name="emailtemplate_form" id="emailtemplate_form" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12">                
                                    ...
                                    <label><input type="radio"  class="with-gap" name="template_email_daemon" id="template_email_daemon" value="PHPMAIL" checked/>  <label for ="template_email_daemon"> PHP Mail</label>
                                    <label> <input type="radio"  class="with-gap" name="template_email_daemon" id="template_email_daemon2" value="SMTP" />   <label for ="template_email_daemon2">SMTP</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 col-sm-6 col-xs-12 col-md-offset-4 text-center">                           
