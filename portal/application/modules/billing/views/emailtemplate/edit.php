...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">     
            <li><a href="<?php echo base_url('Billing/emailtemplate') ?>"><button class="btn btn-primary" type="button">Back to Template Listing Page</button></a> </li>
        </ul>
    </div>
                        ...
                        <form action="<?php echo base_url('Billing/emailtemplateedit/' . param_encrypt($temp_data['id'])) ?>" method="post" name="emailtemplate_form" id="emailtemplate_form" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-6 col-xs-12 ">                
                                    ...
                                    <input type="radio"  class="with-gap" name="template_email_daemon" id="template_email_daemon" value="PHPMAIL" <?php
                                        if ($temp_data['email_daemon'] == 'PHPMAIL') {
                                            echo 'checked';
                                        }
                                        ?>/><label for ="template_email_daemon"> PHP Mail</label>
                                    <input type="radio"  class="with-gap" name="template_email_daemon" id="template_email_daemon2" value="SMTP" <?php
                                        if ($temp_data['email_daemon'] == 'SMTP') {
                                            echo 'checked';
                                        }
                                        ?>/> <label  for ="template_email_daemon2"> SMTP</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <div class="col-md-10 col-sm-6 col-xs-12 col-md-offset-4 ">                                
