...
<div class="container-fluid">
    ...
    <div class="block-header">
        <h2>Incoming(DID) CallerID Rule(s) Management</h2>
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php
                $tab_index = 0;
                echo base_url('endpoints/didrules/') . param_encrypt($data['account_id']) . '/' . param_encrypt(get_logged_user_group());
                ?>"><button class="btn btn-primary" type="button" tabindex="<?php echo $tab_index++; ?>">Back to DID No. Rule Management Page</button></a> </li>
        </ul>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <h2>DID Calls Source Number Translation</h2>
