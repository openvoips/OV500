...
<div class="container-fluid">
     ...
     <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
               <li>
<a href="<?php echo base_url('endpoints/sipdevice/') . param_encrypt($data['account_id']); ?>">

<button class="btn btn-primary" type="button">Back to Endpoints Edit Page</button>
</a>
...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                <input type="radio" class="with-gap" name="voicemail" id="status1" value="1"  <?php if ($account_id_sip_data['voicemail'] == 1) { ?> checked="checked" <?php } ?> /> <label for="status1">Active</label>
                             
                                <input type="radio" class="with-gap" name="voicemail" id="status0" value="0" <?php if ($account_id_sip_data['voicemail'] == 0) { ?> checked="checked" <?php } ?>/>  <label for="status0"> Inactive</label>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                 <input class="with-gap"  type="radio" name="status" id="status1" value="1"  <?php if ($account_id_sip_data['status'] == 1) { ?> checked="checked" <?php } ?> /><label for="status1"> Active</label>
                             
                                <input class="with-gap" type="radio" name="status" id="status0" value="0" <?php if ($account_id_sip_data['status'] == 0) { ?> checked="checked" <?php } ?>/> <label for="status0">Inactive</label>
                            </div>
 ...
 <div class="block-header">
          <h2>Customer Account Configuration Management</h2>
        <ul class="nav navbar-right panel_toolbox">
               <li><a href="<?php echo base_url('endpoints/sipdevice/') . param_encrypt($data['account_id']); ?>"><button class="btn btn-primary" type="button" >Back to Endpoints Edit Page</button></a> </li>
        </ul>
    </div>
</div>    
<script>
