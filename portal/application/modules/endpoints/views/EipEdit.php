                    ...
                    <form action="" method="post" name="account_form" id="account_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <input type="radio" class="with-gap"  name="ip_status" id="status1" value="1"  <?php if ($account_ip_data['ip_status'] == 1) { ?> checked="checked" <?php } ?>  /> <label for="status1">Active</label>
                                  <input type="radio" class="with-gap"  name="ip_status" id="status0" value="0" <?php if ($account_ip_data['ip_status'] == 0) { ?> checked="checked" <?php } ?>  /> <label for="status0">Inactive</label>
                                </div>
