        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    ...
                    <?php
                    if ($data['view_src_did'] == '1' or check_logged_user_group(array('RESELLER'))) {
                        ?>
                        <!---->
                       
                            <div class="header"><h2>DID Calls Source Number Translation Rules</h2></div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                                <a href="<?php echo base_url('endpoints') ?>/editINSRCNo/<?php echo param_encrypt(get_logged_account_id()) . '/' . param_encrypt(get_logged_user_group()); ?>" ><input type="button" value="Manage Rules" name="add_link" class="btn btn-primary"></a>
                            </div>
                    ...
                    <?php } ?>
                    <?php
                    if ($data['view_dst_did'] == '1' or check_logged_user_group(array('RESELLER'))) {
                        ?>
                        <!---->
                       
                            <div class="header"><h2>DID Calls Destination Number Translation Rules</h2></div>
                            <table class="table table-striped jambo_table table-bordered">
                                <thead>
                                    <tr class="headings thc">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                                <a href="<?php echo base_url('endpoints') ?>/EnDIDRule/<?php echo param_encrypt(get_logged_account_id()) . '/' . param_encrypt(get_logged_user_group()); ?>" ><input type="button" value="Manage Rules" name="add_link" class="btn btn-primary"></a>
                            </div>
