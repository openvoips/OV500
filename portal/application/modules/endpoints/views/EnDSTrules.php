...
<div class="container-fluid">
    ...
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php
                $tab_index = 0;
                echo base_url('endpoints/pstnrules/') . param_encrypt($data['account_id']) . '/' . param_encrypt(get_logged_user_group());
                ?>"><button class="btn btn-primary" type="button" tabindex="<?php echo $tab_index++; ?>">Number Translation Rules</button></a> </li>
        </ul>
    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-10">
                                <small style="color: #dd4814;">
                                    ...
                                    <br/>%=>11282550000 : allowing all dialed number and replacing incoming dialed number with 11282550000.
                                </small>
                            </div>
                        </div>
                        <div class="form-group">
