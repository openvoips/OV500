                    ...
                    <form action="" method="post" name="carrier_form" id="carrier_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                     <input class="with-gap"  type="radio" name="voicemail" id="status1" value="1"  <?php echo set_radio('status', '1', TRUE); ?> /> <label for="status1">Active</label>
                                 
                                     <input class="with-gap"  type="radio" name="voicemail" id="status0" value="0" <?php echo set_radio('status', '0'); ?> /><label for="status0"> Inactive</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <input type="radio" class="with-gap" name="status" id="status1" value="1"  <?php echo set_radio('status', '1', TRUE); ?> /> <label for="status1">Active</label>
                                
                                      <input type="radio" class="with-gap" name="status" id="status0" value="0" <?php echo set_radio('status', '0'); ?> /> <label for="status0">Inactive</label>
                                </div>
