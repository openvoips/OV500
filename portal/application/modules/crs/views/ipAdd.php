                ...
                <div class="header">
                    ...
                    <form action="" method="post" name="account_form" id="account_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-6 col-xs-12">
                                <input type="text" name="billingcode" id="billingcode" value= ""  data-parsley-type="alphanum" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <input class="with-gap" type="radio" name="ip_status" id="status1" value="1"  <?php echo set_radio('ip_status', '1', TRUE); ?> /><label for="status1"> Active</label>

                                    <input class="with-gap" type="radio" name="ip_status" id="status0" value="0" <?php echo set_radio('ip_status', '0'); ?> /> <label for="status0">Inactive</label>
                                </div>
