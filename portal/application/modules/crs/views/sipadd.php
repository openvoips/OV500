...
<div class="container-fluid">
                ...
                <div class="header">
                    ...
                    <form action="" method="post" name="carrier_form" id="carrier_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    ...
                                    <input class="with-gap"  type="radio" name="voicemail_enabled" id="voicemail_enabled1" value="Y"   checked="checked"  /> <label for="voicemail_enabled1">Active</label>

                                    <input class="with-gap"  type="radio" name="voicemail_enabled" id="voicemail_enabled0" value="N"  /> <label for="voicemail_enabled0">Inactive</label>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <input class="with-gap"  type="radio" name="status" id="status1" value="1"  <?php echo set_radio('status', '1', TRUE); ?> /> <label for="status1">Active</label>

                                    <input class="with-gap"  type="radio" name="status" id="status0" value="0" <?php echo set_radio('status', '0'); ?> /> <label for="status0">Inactive</label>
                                </div>
    ...
    <div class="block-header">
        <h2>Customer SIP Users Devices(ADD)</h2>
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php echo base_url('voip') . '/editvoip/' . param_encrypt($data['account_id']); ?>/<?php echo $active_tab ?>"><button class="btn btn-primary" type="button" tabindex="<?php echo $tab_index++; ?>">Back to Customer Edit Page</button></a> </li>
        </ul>
    </div>
