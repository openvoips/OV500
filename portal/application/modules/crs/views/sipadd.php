        ...
        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                <label><input type="radio" name="voicemail_enabled" id="voicemail_enabled1" value="Y"  <?php echo set_radio('voicemail_enabled', 'Y', TRUE); ?> /> Active</label>
                            </div>  
                            <div class="radio">
                                <label> <input type="radio" name="voicemail_enabled" id="voicemail_enabled0" value="N" <?php echo set_radio('voicemail_enabled', 'N'); ?> /> Inactive</label>
                            </div>
...
<!--                    <div class="form-group">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 right">
        ...
        <div class="x_title">
            <h2>Customer Account Configuration Management</h2>
            <ul class="nav navbar-right panel_toolbox">             
                <li><a href="<?php  echo base_url('voip') . '/editvoip/' . param_encrypt($data['account_id']);?>/<?php echo $active_tab?>"><button class="btn btn-danger" type="button" tabindex="<?php echo $tab_index++; ?>">Back to Customer Edit Page</button></a> </li>
            </ul>
            <div class="clearfix"></div>
        </div>
    </div>
