            ...
            <div class="card">
                <div class="header">
                    ...
                    <form action="" method="post" name="account_form" id="account_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">Billing Code(this is "Billing" Custom SIP header coming in SIP Invite) 
                            </label>
                            <div class="col-md-7 col-sm-6 col-xs-12">
                                <input type="text" name="billingcode" id="billingcode" value="<?php echo $account_ip_data['billingcode']; ?>"  data-parsley-type="alphanum" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                   <input class="with-gap" type="radio" name="ip_status" id="status1" value="1"  <?php if ($account_ip_data['ip_status'] == 1) { ?> checked="checked" <?php } ?>  /> <label for="status1"> Active</label>
                                
                                      <input class="with-gap" type="radio" name="ip_status" id="status0" value="0" <?php if ($account_ip_data['ip_status'] == 0) { ?> checked="checked" <?php } ?>  /> <label for="status0"> Inactive</label>
                                </div>
