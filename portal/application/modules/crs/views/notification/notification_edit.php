...
<div class="container-fluid">
    <div class="block-header">
        <h2>Low Balance Notification (Edit)</h2>
            ...
            <div class="card">
                ...
                <form action="" method="post" name="account_form" id="account_form" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <div class="radio">
                                <input class="with-gap" type="radio" name="notify_name" id="notify_name1" value="low-balance" <?php if ($notification_data['notify_name'] == 'low-balance') { ?> checked="checked" <?php } ?> /><label for="notify_name1">Low Balance</label>

                                <input class="with-gap" type="radio" name="notify_name" id="notify_name2" value="daily-balance" <?php if ($notification_data['notify_name'] == 'daily-balance') { ?> checked="checked" <?php } ?> /> <label for="notify_name2">Daily Balance</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <input type="text" name="notify_amount" id="notify_amount" value="<?php echo $notification_data['notify_amount']; ?>" placeholder="Alert value" data-parsley-required="" data-parsley-price="true" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-12">
                            <input type="text" name="notify_emails" id="notify_emails" value="<?php echo $notification_data['notify_emails']; ?>" placeholder="Email Address" data-parsley-required="" data-parsley-multipleemail="true" class="form-control col-md-7 col-xs-12"><br>comma seperated mulitiple email address'+
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                <input class="with-gap" type="radio" name="status" id="status1" value="1" <?php if ($notification_data['status'] == 'Y') { ?> checked="checked" <?php } ?> /> <label for="status1"> Active</label>

                                <input class="with-gap" type="radio" name="status" id="status0" value="0" <?php if ($notification_data['status'] == 'N') { ?> checked="checked" <?php } ?> /> <label for="status0"> Inactive</label>
                            </div>
...
<div class="block-header">
    <h2>Low Balance Notification (Edit)</h2>
    <ul class="nav navbar-right panel_toolbox">
        <li><a href="<?php echo base_url('crs') . '/editvoip/' . param_encrypt($data['account_id']); ?>/<?php echo $active_tab ?>"><button class="btn btn-primary" type="button" tabindex="<?php echo $tab_index++; ?>">Back to Customer Edit Page</button></a> </li>
    </ul>
</div>
