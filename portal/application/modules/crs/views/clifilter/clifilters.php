...
if ($active_tab == 'did')
    $add_title = 'Add DID CLI Filter';
else
    $add_title = 'Add PSTN CLI Filter';
    $add_link=   site_url('crs/clifilter/add/' . param_encrypt($data['account_id']) . '/' . $active_tab);
?>
...
<div class="container-fluid">
    <div class="block-header">
     <h2>Customer Account Configuration Management <span class="text-info"><?php echo $data['account_id'] . ' (' . $data['company_name'] . ')'; ?></span></span></h2>
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <ul class="nav nav-tabs bar_tabs2" id="myTab" role="tablist">
                ...
                echo '<li class="nav-item header_section " style="float: right;">';
                echo '<a class="nav-link "  href="'.$add_link.'"   >
                <input type="button" value="'.$add_title.'" name="add_link" class="btn btn-primary" />
                </a>';
                echo '</li>';
                ?>
            </ul>
        ...
        foreach ($section_array as $key => $section_single_array) {
            ...
            if ($key == $active_tab)
                ...
                $class = 'hide';
            ?>
            <div class="x_content content_div <?php echo $class; ?>" id="<?php echo 'id_content_div_' . $key; ?>" style="margin-bottom:10px;">
