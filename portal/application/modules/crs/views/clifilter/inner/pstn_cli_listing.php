        ...
        <form class="block-content form-horizontal " id="search_form" name="search_form" method="post"
            ...
            <div class="form-group">
                ...
                <div class="searchBar  ">
                    ...
                    <input type="button" value="Reset" name="search_reset" id="search_reset2" class="btn btn-info">
                    ...
                    foreach ($cli_data['result'] as $single_row) {
                        ...
                        $str .= '<tr>                                               
                            ...
                            <a href="javascript:void(0);" title="Delete" class="delete"
                                onclick=doConfirmDelete(\'' . $single_row['id'] . '\',"' . $delete_link . '","pstnclifilter_delete")><i class="fa fa-trash"></i></a>
