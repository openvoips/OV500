                    ...
                    <tr >
                        ...
                        <td class=" last">
                             <a href="javascript:void(0);"
                               onclick=doConfirmDelete('<?php echo $dialplan_data['id']; ?>','<?php echo $delete_url;?>','reseller_dialplan_delete') title="Delete" class="delete"><i class="fa fa-trash"></i></a>                      
...
<input type="hidden" name="action" value="OkSaveDialplanReseller">
