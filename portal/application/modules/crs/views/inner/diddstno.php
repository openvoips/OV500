                    ...
                    <table class="table table-striped jambo_table table-bordered">
                        ...
                        <tbody>
                            <?php
                            if (count($accountinfo['translation_rules_incoming']) > 0) {
                                foreach ($accountinfo['translation_rules_incoming'] as $translation_rule_data) {
...
$translation_rule_data = $accountinfo['translation_rules_incoming'];
...
?>
                   <form action="" method="post" name="<?php echo 'tab_form_'.$key;?>" id="<?php echo 'tab_form_'.$key;?>" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <input type="hidden" name="action" value="OkSaveDidDSTrule">    
