...
?>
        ...
        <div class="radio">
            <input class="with-gap"  type="radio" name="itemised_billing" id="itemised_billing1" value="1" <?php if ($itemised_billing_selected == 1) echo 'checked="checked"'; ?> /> <label for="itemised_billing1"> Yes</label>
           <input class="with-gap"  type="radio" name="itemised_billing" id="itemised_billing2" value="0" <?php if ($itemised_billing_selected == 0) echo 'checked="checked"'; ?>/><label for="itemised_billing2"> No</label>
    ...
    <div class="form-group">
        ...
        <div class="radio">
             <input  class="with-gap" type="radio" name="invoice_via_email" id="invoice_via_email1" value="1" <?php if ($invoice_via_email_selected == 1) echo 'checked="checked"'; ?>/><label for="invoice_via_email1"> Yes</label>
              <input  class="with-gap" type="radio" name="invoice_via_email" id="invoice_via_email2" value="0" <?php if ($invoice_via_email_selected == 0) echo 'checked="checked"'; ?>/><label for="invoice_via_email2"> No</label>
        </div>                        
    </div>
    */
    ?>
