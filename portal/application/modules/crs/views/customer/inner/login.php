...
<form action="" method="post" name="<?php echo 'tab_form_' . $key; ?>" id="<?php echo 'tab_form_' . $key; ?>"  data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="form-group">
        ...
        <div class="col-md-7 col-sm-6 col-xs-12">
            <input type="text" name="username" id="username" value="<?php echo $user_data['username']; ?>" class="form-control col-md-7 col-xs-12" data-parsley-required="true" data-parsley-type="alphanum" data-parsley-minlength="6" data-parsley-maxlength="30"  tabindex="<?php echo $tab_index++; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-7 col-sm-6 col-xs-10">
            <input type="text" name="secret" id="secret" value="<?php echo $user_data['secret']; ?>" class="form-control col-md-7 col-xs-12" data-parsley-required="true" data-parsley-minlength="8" data-parsley-maxlength="30" data-parsley-password="" autocomplete="off" >
        </div>                       
    </div>  
...
<!--    <div class="form-group">
        ...
        <div class="col-md-7 col-sm-6 col-xs-12">
            <div class="checkbox">	
                ...
                <input type="checkbox"  id="reset_gcode" name="reset_gcode" value="1" class="with-gap"/>   <label for="reset_gcode">Yes </label>
    ...
    <div class="form-group">
        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
            <?php if (check_account_permission('customer', 'edit')): ?>	
                <button type="button" id="<?php echo 'btnSaveClose' . $key; ?>" class="btn btn-info" onclick="save_button('<?php echo $key; ?>')">Save Portal Login detail</button>
