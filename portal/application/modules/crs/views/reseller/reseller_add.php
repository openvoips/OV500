...
<div class="container-fluid">
    <div class="block-header">
        <h2>Reseller(ADD) Configuration Management</h2>
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php echo site_url('crs') ?>"><button class="btn btn-primary" type="button" >Back to Reseller Listing Page</button></a> </li>
        </ul>
    </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="form-group">
                                        <label  class="control-label col-md-4 col-sm-3 col-xs-12">Caller ID rules Checking</label>
                                        <div class="col-md-8 col-sm-6 col-xs-12">

                                            <input type="radio" name="cli_check" id="cli_check1" value="1" class="with-gap" <?php echo set_radio('cli_check', '1', TRUE); ?>  /> 
                                            <label for="cli_check1">Yes</label>

                                            <label> <input type="radio" name="cli_check" id="cli_check2" value="0" class="with-gap" <?php echo set_radio('cli_check', '0'); ?>  />
                                                <label for="cli_check2">No</label>


                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label  class="control-label col-md-4 col-sm-3 col-xs-12">PSTN Number rules checking</label>
                                        <div class="col-md-8 col-sm-6 col-xs-12">

                                            <input type="radio" name="dialpattern_check" id="dialpattern_check1" value="1" class="with-gap" <?php echo set_radio('dialpattern_check', '1', TRUE); ?>  />
                                            <label for="dialpattern_check1">Yes</label>

                                            <input type="radio" name="dialpattern_check" id="dialpattern_check2" value="0" class="with-gap" <?php echo set_radio('dialpattern_check', '0'); ?>  />
                                            <label for="dialpattern_check2">No</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            ...
                                            <input type="radio" name="llr_check" id="llr_check1" value="1" class="with-gap" <?php echo set_radio('llr_check', '1', TRUE); ?>  /> 
                                            <label for="llr_check1">Yes</label>

                                            <input type="radio" name="llr_check" id="llr_check2" value="0" class="with-gap" <?php echo set_radio('llr_check', '0'); ?>  /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            ...
                                            <input type="radio" name="media_rtpproxy" id="media_rtpproxy1" value="1" class="with-gap" <?php echo set_radio('media_rtpproxy', '1', TRUE); ?>  /> 
                                            <label for="media_rtpproxy1">Yes</label>

                                            <input type="radio" name="media_rtpproxy" id="media_rtpproxy2" value="0" class="with-gap" <?php echo set_radio('media_rtpproxy', '0'); ?>  /> 
                                    ...
                                    <div class="form-group" id="id_transcoding_div">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input type="radio" name="media_transcoding" id="media_transcoding1" value="1" class="with-gap" <?php echo set_radio('media_transcoding', '1', TRUE); ?>  />
                                            <label for="media_transcoding1">Yes</label>
                                            <input type="radio" name="media_transcoding" id="media_transcoding2" value="0" class="with-gap" <?php echo set_radio('media_transcoding', '0'); ?>  /> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input type="radio" name="status_id" id="status1" value="1" class="with-gap" <?php echo set_radio('status_id', '1', TRUE); ?>  /> 
                                            <label for="status1">Active</label>
                                            <input type="radio" name="status_id" id="status0" value="0" class="with-gap" <?php echo set_radio('status_id', '0'); ?> /> 
