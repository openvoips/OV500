            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <li>  
                    <?php if (check_account_permission('customer', 'add')): ?>    
                        ...
                        <a  href="<?php echo site_url('crs/customers/add'); ?>">
                            <input type="button" value="Add Customer" name="add_link" class="btn btn-primary"></a>

                    <?php endif; ?>
                    <?php if (check_account_permission('reseller', 'add')): ?>

                        <a  href="<?php echo site_url('crs/resellers/add'); ?>">
                            <input type="button" value="Add Reseller" name="add_link" class="btn btn-warning"></a>
            ...
            <div class="card">
                ...
                <div class="body">        
                    ...
                    <div class="table-responsive">
                        <table class="table table table-bordered" id="table-sort">
                            <thead>
                                <tr class="headings thc">               
                                    <th class="column-title"><?php echo wordwrap('Account ID', 10, "<br>\n", false); ?></th>
                                    <th class="column-title"><?php echo wordwrap('Account Type', 10, "<br>\n", false); ?></th>
                                    <th class="column-title">Tariff</th>
                                    <th class="column-title">Balance</th>                             
                                    <th class="column-title">Credit</th>                             
                                    <th class="column-title"><?php echo wordwrap('Usable Balance', 10, "<br>\n", false); ?></th>
                                    <th class="column-title">Currency</th>
                                    <th class="column-title"><?php echo wordwrap('Portal Access', 10, "<br>\n", false); ?></th>
                                ...
                                if ($voip_data['result'] > 0) {
                                    foreach ($voip_data['result'] as $listing_row) {
                                        ...
                                        <tr> <?php
                                            ...
                                            <td ><?php echo wordwrap($acc, 15, "<br>\n", false); ?></td>
                                            <?php
                                            $account_type = '';
                                            ...
                                            <?php if (strlen($listing_row['tariff_id']) == 0) { ?>
                                                ...
                                                $tariff = $listing_row['tariff_name'] . ' (' . $listing_row['tariff_id'] . ')';
                                                ?>
                                                <td><?php echo wordwrap($tariff, 15, "<br>\n", false); ?></td>
                                            <?php } ?>
                                            ...
                                            <td><font size="1"><?php echo str_replace(',', '<br>', $listing_row['web_username']); ?></font></td> 
                                            <!--<td><font size="1"><?php echo str_replace(',', '<br>', $listing_row['sip_user']); ?></font></td>-->
                                            ...
                                            <td class=" last" >
                                                ...
                                                <a href="<?php echo base_url(); ?>crs/editvoip/<?php echo param_encrypt($listing_row['account_id']); ?>" title="Services Edit" class="edit"><i class="fa fa-edit "></i></a>
                                                ...
                                                if (check_logged_user_type(array('ADMIN', 'SUBADMIN', 'RESELLERADMIN', 'ACCOUNT'))):
                                                    ?>  
                                                    <a href="<?php echo site_url(); ?>crs/payment/index/<?php echo param_encrypt($listing_row['account_id']); ?>" title="Payment"><i class="fa fa-usd"></i></a>
                                                ...
                                                <?php if ($listing_row['account_type'] === 'CUSTOMER') { ?>     
                                                    <a href="<?php echo site_url(); ?>crs/clifilter/index/<?php echo param_encrypt($listing_row['account_id']); ?>" title="CLI Filter"><i class="fa fa-phone"></i></a>
                                                    <a href="<?php echo site_url(); ?>crs/customers/statement/<?php echo param_encrypt($listing_row['account_id']); ?>" title="Account Statement"><i class="fa fa-book"></i></a>                                         
                                                    ...
                                                    ?>
                                                    <a href="<?php echo site_url(); ?>crs/resellers/statement/<?php echo param_encrypt($listing_row['account_id']); ?>" title="Account Statement"><i class="fa fa-book"></i></a>
