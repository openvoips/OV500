...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <?php if (check_account_permission('user', 'add')): ?> <li><a href="<?php echo site_url('crs/payment/index/' . param_encrypt($account_result['account_id'])); ?>"><input type="button" value="Back to Listing Page" name="add_link" class="btn btn-primary"></a></li><?php endif; ?>
        </ul>
    </div>
                                ...
                                <div class="body">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered">           
                                            ...
                                            <tr >
                                                <th>Credit( A balance provided by system admin as loan) </th>
                                                <th><?php echo number_format($account_result['balance']['credit_limit'], $dp, '.', ''); ?> </th>
                                            </tr>
                                            <tr >
                                                <th>Balance ( Current balance + Credit)</th>
                                    ...
                                    <?php if (isset($credit_scheduler_result) && count($credit_scheduler_result['result']) > 0): ?>            
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2>Credit will remove as per below table Scheduler</h2>
                                                <ul class="nav navbar-right panel_toolbox">
                                                ...
                                                <table class="table table-striped jambo_table table-bordered">
                                                    <thead>
                                                        <tr class="headings thc">
                                                            <th class="column-title">What credit amount</th>
                                                            <th class="column-title">When credit will remove</th>
