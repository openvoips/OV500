                ...
                <div class="header">
                    <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo base_url(); ?>crs/payment/trace">
                        ...
                        <div class="form-group">       
                            ...
                            <div class="col-md-2 col-sm-9 col-xs-12">
                                <input type="text"  name="card_number" id="card_number" value="<?php echo $_SESSION['search_tracing_data']['s_card_number']; ?>" class="form-control data-search-field" placeholder="Card Number">
                            </div> 
                        </div>
                    ...
                    <div class="body">
                        <div class="row">  
                            <?php dispay_pagination_row_bsd($total_records, $_SESSION['search_tracing_data']['no_of_rows'], $pagination); ?>
                        </div>
