                    ...
                    <form action="" method="post" name="sip_form" id="sip_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <input class="with-gap"  type="radio" name="voicemail_enabled" id="voicemail_enabled1" value="Y"  <?php if ($account_id_sip_data['voicemail_enabled'] == 'Y') { ?> checked="checked" <?php } ?> /> <label for="voicemail_enabled1">Active</label>

                                    <input class="with-gap"  type="radio" name="voicemail_enabled" id="voicemail_enabled0" value="N" <?php if ($account_id_sip_data['voicemail_enabled'] == 'N') { ?> checked="checked" <?php } ?>/> <label for="voicemail_enabled0">Inactive</label>
                                </div>
