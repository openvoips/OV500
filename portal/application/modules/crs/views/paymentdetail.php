<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php echo site_url(); ?>payment/index/<?php echo param_encrypt($listing_row['account_id']); ?>"><input type="button" value="Add Payment" name="add_link" class="btn btn-warning"></a></li>
        </ul>
    </div>
