<div class="container-fluid">
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo site_url('report/paymenthistory'); ?>">
                                ...
                                if ($listing_data['result'] > 0) {
                                    foreach ($listing_data['result'] as $payment_data) {
                                        ...
                                        if ($payment_data['create_dt'] != '') {
                                            ...
                                            $create_dt_display = date('Y-m-d', $create_dt_timestamp);
                                        }
                                        ...
                                        if ($payment_data['payment_option_id'] === 'ADDBALANCE')
                                            $payment_option = '<span class="label label-primary">' . $payment_data['payment_option'] . '</span>';
                                        else
                                            $payment_option = '<span class="label label-warning">' . $payment_data['payment_option'] . '</span>';
                                        ?>
                                        <tr> 
