        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    ...
                    <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo base_url(); ?>report/vendorprofitdetails">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-8 col-xs-12">
                                <input type="text" name="vendortime" id="reservation-time" class="form-control" value="<?php echo $_SESSION[$search_session_key]['vendortime']; ?>" />
                            </div>
