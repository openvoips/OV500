...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li> <a href="<?php echo base_url('activitylog/index'); ?>" title="Site Activity Log" class="highlight pull-right"><input type="button" value="Back to Site Activity Log Page" name="" id="" class="btn btn-primary"></a></li>
        </ul>
    </div>
