...
<?php
//	echo '<pre>';print_r($data);print_r($route_data['result']);echo '</pre>';
$dialplan_data = current($data['dialplan']);
?>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="" method="post" name="dialplan_form" id="dialplan_form" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <input type="hidden" name="account_id" value="<?php echo $data['account_id']; ?>"/>      
                    <input type="hidden" name="id" value="<?php echo $dialplan_data['id']; ?>"/> 
                            ...
                            <select name="dialplan_id" id="dialplan_id" data-parsley-required="" class="combobox form-control">
                                ...
                                if (count($route_data) > 0) {
                                    foreach ($route_data as $route_array) {
                                        $selected = ' ';
                                        if ($dialplan_data['dialplan_id'] == $route_array['dialplan_id'])
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-6 col-xs-10">                  
                            <input type="text" name="maching_string" id="maching_string" value="<?php echo $display_string_array[0]; ?>" data-parsley-required=""  class="form-control"><!-- data-parsley-pattern="^\d*%$" data-parsley-pattern-message="Number with % at end" -->
                        </div>
