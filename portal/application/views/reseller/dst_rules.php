...
<div class="">
    ...
    <div class="col-md-8 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><?php echo ucfirst($reseller_type); ?>  Destination Number Translation Rules (MANAGE)</h2>
                <ul class="nav navbar-right panel_toolbox">
            ...
            <div class="x_content">
                ...
                <form action="" method="post" name="carrier_form" id="carrier_form" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-3 col-xs-12" for="first-name">Account ID </label>
