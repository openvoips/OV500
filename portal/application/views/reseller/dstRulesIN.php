...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 right">    
        <div class="x_title">
            <h2>Reseller DID Calls Destination Number Translation</h2>
            <ul class="nav navbar-right panel_toolbox">     
                <li><a href="<?php $tab_index = 0;
echo base_url('resellers') . '/edit/' . param_encrypt($data['account_id']) ?>"><button class="btn btn-danger" type="button" tabindex="<?php echo $tab_index++; ?>">Back to Reseller Edit Page</button></a> </li>
            </ul>
            <div class="clearfix"></div>
        </div>
    </div>    
...
<?php if (check_account_permission('reseller', 'edit')): ?>	
                                ...
                                <button type="button" id="btnSaveClose" class="btn btn-info">Save & Go Back to Reseller Edit Page</button>
<?php endif; ?>
                        </div>
                    </div>
