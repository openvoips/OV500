...
<div class="container-fluid">
    <div class="block-header">
        <h2>Carrier Incoming Caller ID Translation Rules</h2>
                    ...
                    <form action="" method="post" name="carrier_form" id="carrier_form" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12" style="color: blue">                  
                                ...
                                <br/>1|%=>% : allow only 1 prefix CLI and removing 1 prefix from CLI.
                                <br/>1|%=>001% : allow only 1 prefix CLI and removing 1 and adding 001 prefix in CLI.
                                <br/>1{4}|%=>% : allowing only 1 prefix CLI with 4 length and removing 1 from the CLI.
                                <br/>{10}%=>91% : allowing only 10 digit CLI and adding 91 prefix in the CLI.
                                <br/>%=>11149800228 : allowing all CLI and replacing incoming CLI with 11149800228.
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12" style="color: blue">                  
                                ...
                                % : Block the all CLI.
                                <br/>1% : Block the stating with 1 prefix CLI.    
                                <br/>41149800228 : Block the 11149800228 CLI Only.
