    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <div class="row">  
                        <?php dispay_pagination_row_bsd($total_records, $_SESSION['search_carrier_data']['s_no_of_records'], $pagination);
                        ?>    
                    </div>
                                    ...
                                    foreach ($data['result'] as $carrier_data) {
                                        ...
                                        <tr >                                
                                            ...
                                            <td class=" last"> 
                                                ...
                                                ?>
                                                <a href="<?php echo base_url(); ?>carriers/diversion/<?php echo param_encrypt($carrier_data['carrier_id']); ?>" title="Edit" class="edit"><i class="fa fa-arrows"></i></a>
                                                <?php
