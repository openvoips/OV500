    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                <a href="<?php echo base_url() ?>carriers/editDSTNo/<?php echo param_encrypt($data['carrier_id']); ?>/<?php echo $key ?>" ><input type="button" value="Edit Rules" name="add_link" class="btn btn-primary"></a>
            </div>
        </div>
