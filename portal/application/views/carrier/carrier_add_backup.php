            ...
            <div class="x_content">
                ...
                <form action="<?php echo base_url(); ?>carriers/addC" method="post" name="carrier_form" id="carrier_form" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="radio">
                                <label><input type="radio" name="diversion_header_option" id="diversion_header_option1" value="1" <?php echo set_radio('diversion_header_option', '1', TRUE); ?> /> Active</label>
                                <label><input type="radio" name="diversion_header_option" id="diversion_header_option0" value="0" <?php echo set_radio('diversion_header_option', '0'); ?> /> Inactive</label>
                            </div>                    
                        </div>
                    </div>
                    <div class="diversion_class">
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <label><input type="radio" name="diversion_header_as_comingcli_db" id="diversion_header_as_comingcli_db1" value="1" <?php echo set_radio('diversion_header_as_comingcli_db', '1', TRUE); ?> /> As Incoming</label>
                                    <label><input type="radio" name="diversion_header_as_comingcli_db" id="diversion_header_as_comingcli_db0" value="0" <?php echo set_radio('diversion_header_as_comingcli_db', '0'); ?> /> From DB</label>
                                </div>                    
                            </div>
                        </div>
                        <div class="form-group ">
