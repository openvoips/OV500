            ...
            <div class="card">
                <div class="header">
                    ...
                    <?php if ($searching): ?>
                        ...
                        <div class="body">
                            <div class="row">  
                                <?php dispay_pagination_row_bsd($total_records, $_SESSION['search_dialplan_data']['s_no_of_records'], $pagination);
                                ?>    
                            </div>
                                        ...
                                        if ($listing_count > 0) {
                                            ...
                                            foreach ($listing_data as $listing_row) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $listing_row['carrier_id']; ?> <a href="<?php echo base_url(); ?>carriers/edit/<?php echo param_encrypt($listing_row['carrier_id']); ?>"><u><?php echo $listing_row['carrier_id']; ?></u></a></td>
                            ...
                            <div class="row">  
                                <?php
                                dispay_pagination_row_bsd($total_records, $_SESSION['search_dialplan_data']['s_no_of_records'], $pagination);
                                ?>    
                            </div>
                        <?php endif; ?>
                    </div>
