...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <?php if (check_account_permission('user', 'add')): ?> <li><a href="<?php echo base_url() ?>users/addA"><input type="button" value="Add System User" name="add_link" class="btn btn-primary"></a></li><?php endif; ?>
        </ul>
    </div>
