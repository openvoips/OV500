            ...
            <div class="card">
                <div class="header">
                    ...
                    <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <form action="<?php echo base_url(); ?>tariffs/editTP/<?php echo param_encrypt($data['tariff_id']); ?>" method="post" name="edit_form" id="edit_form" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <div class="radio">
                                            <input class="with-gap" type="radio" name="frm_status" id="status1" value="1"  <?php if ($data['tariff_status'] == 1) { ?> checked="checked" <?php } ?> /> <label for="status1">Active</label>
                                            <input class="with-gap" type="radio" name="frm_status" id="status0" value="0" <?php if ($data['tariff_status'] == 0) { ?> checked="checked" <?php } ?> /> <label for="status0">Inactive</label>
                                        </div>                    
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="header">
                                <h3> Currently Assigned Ratecard(s) List</h3>
                            </div>
                            <div class="body">
                                <h2 style="margin-bottom: 10px;">OutGoing(PSTN) Calls Rate's Ratecard List</h2>                            
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="body">
                                <h2 style="margin-bottom: 10px;">Incoming(DID's) Calls Rate's Ratecard List</h2>                           
