    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="header">
                    <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo site_url('MyRates'); ?>">
                        <input type="hidden" name="search_action" value="search" />
                        <input type="hidden" name="no_of_rows" id="no_of_rows" value="" />
                        <div class="form-group">
                            <label class="control-label col-md-2 col-sm-4 col-xs-12">Prefix</label>
                            <div class="col-md-4 col-sm-8 col-xs-12">
                                <input type="text" name="prefix" id="prefix" value="<?php echo $_SESSION[$search_session_key]['prefix']; ?>" class="form-control data-search-field" placeholder="Prefix">
                            </div>
                            <label class="control-label col-md-2 col-sm-4 col-xs-12">Destination</label>
                            <div class="col-md-4 col-sm-8 col-xs-12">
                                <input type="text" name="dest" id="dest" value="<?php echo $_SESSION[$search_session_key]['dest']; ?>" class="form-control data-search-field" placeholder="Destination">
                            </div>	
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <select name="ratecard_for" id="ratecard_for" class="form-control data-search-field">
                                    ...
                                    <option value="OUTGOING" <?php if ($_SESSION[$search_session_key]['ratecard_for'] == 'OUTGOING') echo 'selected'; ?>>Outgoing Rates</option>
                                    <option value="INCOMING" <?php if ($_SESSION[$search_session_key]['ratecard_for'] == 'INCOMING') echo 'selected'; ?>>Incoming Rates</option>
                                </select>
                            </div>        </div>
                        <div class="form-group">         
                            <div class="searchBar text-center">
                                ...
                                <a href="javascript:void(0);"  onclick=doOpenModal() title="Delete"><input type="button" value="Download Rate Card" name="add_link" class="btn bg-blue-grey"></a>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-9 col-xs-12 text-right hide" id="id_error_div">
                ...
                <?php if ($searching): ?>
                    ...
                    //ddd($_SESSION[$search_session_key]);
                    ?>
                </div>
