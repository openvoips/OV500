...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <li><a href="<?php echo base_url('rates'); ?>"><button class="btn btn-primary" type="button">Back to Rate Listing Page</button></a> </li>
        </ul>
    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <div class="radio">
                                            ...
                                            <input type="radio"  class="with-gap" name="frm_status" id="status1" value="1"  <?php if ($data['rates_status'] == 1) { ?> checked="checked" <?php } ?> /><label for="status1"> Active</label>
                                            <input type="radio"  class="with-gap" name="frm_status" id="status0" value="0" <?php if ($data['rates_status'] == 0) { ?> checked="checked" <?php } ?>/><label for="status0"> Inactive</label>
