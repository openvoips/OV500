...
<div class="container-fluid">
    <div class="block-header">
        ...
        <ul class="nav navbar-right panel_toolbox">
            <?php if (check_account_permission('ratecard', 'add')): ?> <li><a href="<?php echo base_url() ?>ratecard/addRC"><input type="button" value="Add Ratecard" name="add_link" class="btn btn-warning"></a></li><?php endif; ?>
        </ul>
    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">       
                    <div class="row">  
                        <?php
                        dispay_pagination_row_bsd($total_records, $_SESSION['search_ratecard_data']['s_no_of_records'], $pagination);
                        ?>    
                    </div>
