<div class="container-fluid">
	<div class="block-header">
		<h2>Add Blocked CLI</h2>
		<ul class="nav navbar-right panel_toolbox">
			<li><a href="<?php echo site_url('blockcli') ?>"><button class="btn btn-primary" type="button">Back to
						Blocked CLI Listing Page</button></a> </li>
		</ul>
	</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<div class="card">
					<div class="header">
						...
						<form action="<?php echo base_url(); ?>blockcli/add" method="post" name="add_form" id="add_form"
							...
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-5 col-xs-12" for="first-name">CLI <span
										class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">

									<input type="text" name="cli" id="cli" value="<?php echo set_value('cli'); ?>"
										data-parsley-required="" data-parsley-minlength="4"
										class="form-control col-md-7 col-xs-12" placeholder="CLI">
								</div>
							</div>
							<div class="form-group">
				...
				<div class="card">
					<div class="header">
						<form class="block-content form-horizontal " id="add_form2" name="add_form2" method="post"
							action="<?php echo base_url() ?>blockcli/add" data-parsley-validate
							...
							<input type="hidden" name="button_action" id="button_action2" value="">
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="file" name="file_blockcli_number" id="file_blockcli_number" class=""
