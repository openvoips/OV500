<div class="container-fluid">
	<div class="block-header">
		...
		<ul class="nav navbar-right panel_toolbox">
			<li><a href="<?php echo base_url() ?>blockcli/add"><input type="button" value="Add CLI" name="add_link"
			...
			<div class="card">
				<div class="header">
					...
					<form class="block-content form-horizontal " id="search_form" name="search_form" method="post"
						action="<?php echo site_url('blockcli/index'); ?>">
						<input type="hidden" name="search_action" value="search" />
						<input type="hidden" name="no_of_rows" id="no_of_rows" value="" />
						<div class="form-group">
							<label class="control-label col-md-2 col-sm-3 col-xs-12">CLI</label>
