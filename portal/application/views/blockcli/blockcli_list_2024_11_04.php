<script src="<?php echo base_url() ?>theme/vendors/parsleyjs/dist/parsley.min.js"></script>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
		...
		<div class="x_title">
			...
			<ul class="nav navbar-right panel_toolbox">
		  		...
		  		<li><a href="<?php echo base_url()?>blockcli/add"><input type="button" value="Add CLI" name="add_link" class="btn btn-primary"></a></li>				
			</ul>
      ...
      <div class="x_content">
		 ...
		 <form class="block-content form-horizontal " id="frmSearchDnd" name="frmSearchDnd"  method="post" action="<?php echo base_url()?>blockcli/index" data-parsley-validate >
			<input type="hidden" name="search_action" value="search" />
			
			
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">CLI</label>
				<div class="col-md-6 col-sm-9 col-xs-12">
				  	<input type="text" name="cli" id="cli" value="<?php echo $_SESSION['search_blockcli_data']['cli']; ?>" class="form-control data-search-field" placeholder="CLI">
				</div>
			...
			<br/>
			 <div class="form-group pull-right">      
					...
					<div class="btn-group">
						...
						{
							echo '<li><a href="'.base_url().'blockcli/index/export/'.param_encrypt($export_format).'">'.strtoupper($export_format).'</a></li>';
						}							
						?>                            
						</ul>
					</div>
 ...
 <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
		 <form class="block-content form-horizontal " id="frmdndnumber" name="frmdndnumber"  method="post" action="<?php echo base_url()?>blockcli/index" data-parsley-validate  enctype="multipart/form-data"> 
		  <div class="form-group">
				...
				<div class="col-md-6 col-sm-9 col-xs-12">
				  	 <input type="file" name="file_blockcli_number" id="file_blockcli_number" class=""   data-parsley-fileextension='csv' />
				</div>
