...
<div class="col-md-12 col-sm-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content"> 
            <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo base_url(); ?>cdrs/failed_calls/">
                ...
                <div class="form-group">
                    <?php if ($logged_user_type != 'CUSTOMER') { ?>
                        ...
                        <div class="col-md-2 col-sm-9 col-xs-12">
                            <select class="form-control" id="user_type" name="user_type">
                                <?php if ($get_logged_account_level == 0) { ?>
                                    <option value="U"  <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'U') echo 'selected'; ?>>User</option>
                                    <option value="R1" <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'R1') echo 'selected'; ?>>Reseller 1</option>
                                <?php } ?>
                                <?php if ($get_logged_account_level == 1) { ?>
                                    <option value="U"  <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'U') echo 'selected'; ?>>User</option>
                                    <option value="R2" <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'R2') echo 'selected'; ?>>Reseller 2</option>
                                <?php } ?>
                                <?php if ($get_logged_account_level == 2) { ?>
                                    <option value="U"  <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'U') echo 'selected'; ?>>User</option>
                                    <option value="R3" <?php if ($_SESSION['search_failed_data']['s_cdr_user_type'] == 'R3') echo 'selected'; ?>>Reseller 3</option>
                                <?php } ?>
                        ...
                        <div class="col-md-2 col-sm-9 col-xs-12">
                            <input type="text" name="user_account" id="user_account" value="<?php echo $_SESSION['search_failed_data']['s_cdr_user_account']; ?>" class="form-control data-search-field" placeholder="Account">
                        </div>	
                    <?php } ?>
                    ...
                    <?php if (isset($all_field_array['USER-CLI'])): ?>	
                        ...
                        <div class="col-md-2 col-sm-9 col-xs-12">
                            <input type="text" name="user_cli" id="user_cli" value="<?php echo $_SESSION['search_failed_data']['s_cdr_user_cli']; ?>" class="form-control data-search-field" placeholder="User CLI">
                        </div>	
                    <?php endif; ?>
                    ...
                    <div class="col-md-2 col-sm-9 col-xs-12">
                        <input type="text" name="user_ip" id="user_ip" value="<?php echo $_SESSION['search_failed_data']['s_cdr_user_ip']; ?>" class="form-control data-search-field" placeholder="User IP">
                    </div>
        ...
        <div class="form-group">
            <div class='input-group date' id='myDatepicker'>
                <input type='text' class="form-control" id="start_dt" name="start_dt" readonly data-parsley-required="" 
                value="<?php echo ($_SESSION['search_failed_data']['s_cdr_start_dt']) ? $_SESSION['search_failed_data']['s_cdr_start_dt'] : date("Y-m-01 00:00", time()); ?>" />
            ...
            <div class='input-group date' id='myDatepicker1'>
                <input type='text' class="form-control" id="end_dt" name="end_dt" readonly data-parsley-required="" 
                value="<?php echo ($_SESSION['search_failed_data']['s_cdr_end_dt']) ? $_SESSION['search_failed_data']['s_cdr_end_dt'] : date("Y-m-t 23:59", time()); ?>" />
                <span class="input-group-addon">
                   <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                foreach ($export_format_array as $export_format) {
                                    echo '<li><a href="' . base_url() . 'cdrs/failed_calls/export/' . param_encrypt($export_format) . '">' . strtoupper($export_format) . '</a></li>';
                                }
                                ?>                            
                            </ul>
                        </div>
...
<script>
    $(function () {
        ...
        $('#time_range').val("<?php echo $_SESSION['search_failed_data']['s_time_range']; ?>");
