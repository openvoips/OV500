...
<div class="">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <?php if (count($data['ip']) > 0 and $data['view_ipdevices'] == '1') { ?>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <table class="table table-striped jambo_table table-bordered">
                            ...
                            <tbody>
                                ...
                                if (count($data['ip']) > 0) {
                                    ...
                                    ?>
                                    <tr>
                                        <td colspan="15" align="center"><strong>No Record Found</strong></td>
                                    </tr>
                                    <?php
                                }
                                ?>
        ...
        <?php
        if ($data['view_sipdevice'] == '1') {
            ?>
            <!---->
            <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Customer SIP/Mobile Users Devices</h2>
                        <ul class="nav navbar-right panel_toolbox">
                    ...
                    <div class="x_content">
                        <table class="table table-striped jambo_table table-bordered">
                            <thead>
                                <tr class="headings thc">
                                    <th class="column-title">SIP/Mobile Device Username/Extension</th>
                                    <th class="column-title">SIP/Mobile Device Password</th>
                                    <th class="column-title">Local Extension No</th>                              
                                    <th class="column-title">Maximum Call Sessions</th>
                                    <th class="column-title">Call Sessions per Second</th>
                                    ...
                                    <th class="column-title">Local VoiceMail</th>
                                    <th class="column-title">Status </th>
                                    <th class="column-title">Action </th>
                                </tr>
                            </thead>
        ...
        <?php
        if ($data['view_src_out'] == '1' or check_logged_user_group(array('RESELLER'))) {
            ?>
            <!---->
            <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="x_panel">
        ...
        <?php } ?>
        <?php
        if ($data['view_dst_out'] == '1' or check_logged_user_group(array('RESELLER'))) {
            ?>
            <!----->
            <div class="col-md-12 col-sm-6 col-xs-12">
                <div class="x_panel">
