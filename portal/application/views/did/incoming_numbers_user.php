                            ...
                            <tbody>
                                ...
                                if (count($did_data['result']) > 0) {
                                    foreach ($did_data['result'] as $did_data) {
                                        ...
                                        echo '<tr>';
                                        echo '<td class="a-center "> 	<input type="checkbox" class="check-row1" name="did_number_list" id="lead_id_list_' . $did_data['did_id'] . '" value="' . $did_data['did_number'] . '"> 	<label for="lead_id_list_' . $did_data['did_id'] . '">&nbsp;</label></td>';
