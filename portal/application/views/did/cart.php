...
<?php
if (isset($sitesetup_data['prorata_billing']) && $sitesetup_data['prorata_billing'] == '1')
            ...
            <div class="card">
                ...
                <div class="body">	
                    ...
                    <div class='row'>                     
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php if ($cart_count > 0) { ?>
                                <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                                    <input type="button" value="Remove All Number(s)" id="id_empty_cart" class="btn btn-danger btn-xs" onclick="DoEmptyCart()"/>    
                                </div>
                            <?php } ?>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 p-r-30 p-l-30">
                            ...
                            if ($cart_count > 0) {
                                ...
                                if ($prorata_billing) {
                                    $rental_monthly_charge = $rental_total;
                                    $setup_monthly_charge = $setup_total;
                                } else {
...
//print_r($setup_charges);
                                ...
                                <div class="x_panel" id="id_price_block"> 
                                    <div class="x_content   row cart_div"> 

                                        <?php if ($prorata_billing) { ?>
                                            <div class="col-md-12 row cart_div" style="border-bottom:1px solid #ddd;">Charges Detail</div>
                                            <div class="row cart_div"> 
                                                <div class="col-md-8">Total Rental </div>
                                                <div class="col-md-4 text-right"><?php echo number_format($rental_cost, 4); ?></div>
                                            </div>
                                            <div class="row cart_div" style="border-bottom:1px dashed #ddd;">
                                                <div class="col-md-8">Total Setup </div>
                                                <div class="col-md-4 text-right"><?php echo number_format($setup_cost, 4); ?></div>
                                            </div>
                                            <div class="row cart_div" style="border-bottom:1px dashed #ddd;">
                                                <div class="col-md-8">Total Tax (<?php echo $tax . '%'; ?>)</div>
                                                <div class="col-md-4 text-right"><?php echo number_format($tax_total, 4); ?></div>
                                            </div>
                                            <div class="row cart_div" style="border-bottom:1px dashed #ddd;">
                                                <div class="col-md-8"><strong>Total Amount</strong></div>
                                                <div class="col-md-4 text-right"><strong><?php echo number_format($amount_total, 4); ?></strong></div>
                                            </div>
                                        <?php } else { ?>
                                        ...
                                        <div class="row" style="margin:5px auto auto 5px; font-size:11px;">                                      	
                                            <p style="margin-bottom:0px; padding-bottom:0px;">* Number setup charges is one time charge and not refundable.</p>
                                ...
                                <div class="x_panel" id="id_purchase_block">    
                                    <div class="x_content   row">
                                        ...
                                        <form action="<?php echo site_url('dids/cart'); ?>" method="post" name="assign_form_bulk" id="assign_form_bulk" data-parsley-validate class="form-horizontal ">
                                            <input type="hidden" name="action" value="OkPurchaseDidBulk">
                                            <div class="form-group">
                                                <label class="control-label col-md-4 text-left col-sm-6 col-xs-12">I accepts the terms & conditions <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12 text-left">
                                                    <input class="form-control" type="checkbox" id="terms" value="yes" data-parsley-required="true" data-parsley-error-message="Please Accepts T&C"/> 
                                                    <label for="terms"></label>
                                                </div>								
                                            </div>
                                            <div class="form-group row text-left">
                                                <label class="control-label col-md-4 col-sm-3 col-xs-12">Configure Destination </label>
                                                <div class=" col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control" type="checkbox" id="id_checkbox_configure_dest" name="id_checkbox_configure_dest" value="yes"/>
                                                    <label for="id_checkbox_configure_dest"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row dest_configure_related hide">
                                                <label class="control-label col-md-4 col-sm-6 col-xs-12">Destination Type <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" name="dst_type" id="dst_type" >
                                                        ...
                                                        <option value="CAMPAINGN" >Campaign</option>
                                                    </select>
                                                </div>
                                            </div>

                                            <div class="form-group dest_configure_related hide">
                                                <label class="control-label col-md-4 col-sm-6 col-xs-12">Destination Endpoint <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
