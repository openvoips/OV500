            ...
            <div class="x_panel">
                ...
                <div class="x_content row">
                    ...
                    <div class='row'>                     
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 " style="margin-top: 6px !important;">
                                    ...
                                    <div class="x_content   row">
                                        ...
                                        <form action="<?php echo site_url('dids/cart'); ?>" method="post" name="assign_form_bulk" id="assign_form_bulk" data-parsley-validate class="form-horizontal ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 text-left"><input class="form-control" type="checkbox" id="terms" value="yes" data-parsley-required="true" data-parsley-error-message="Please Accepts T&C"/> </div>								
                                            </div>
                                            ...
                                            <div class="form-group dest_configure_related hide" id="div_dst_type">
                                                <label class="control-label col-md-4 col-sm-6 col-xs-12">Failover Destination Type </span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group dest_configure_related hide" id="div_dst_endpoint">
                                                <label class="control-label col-md-4 col-sm-6 col-xs-12">Failover Destination Endpoint </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
