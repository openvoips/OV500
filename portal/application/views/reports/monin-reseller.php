...
<div id="analytics" class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_content">
            <div class="col-md-12 col-sm-12 col-xs-12" >
                ...
                <div class="row">
                    <table class="table table-condensed table-bordered">
                        <tr>
                            <td id="customer_usage_id" class="text-success">&nbsp;Reseller</td>         	
                        </tr>   
                    </table>
                </div>           
            ...
            <div class="col-md-5 col-sm-5 col-xs-12" style="padding: 0 0 0 0px;">
            ...
            $.get(target_url, function (data, status) {//alert("start 2");
                ...
                $.each(data, function (key, value) {
                    ...
                    if (key == 'customer_call_stat') {
                        ...
                        $.show_carrier_call_stat(value);//removecar
                    }
                });
                $('.loading').html('');
                is_loading3 = false;
