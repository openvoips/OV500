            ...
            <div class="card clearfix">
                <div class="body clearfix">                
                    <div class="col-md-6 col-sm-6 text-center" style="" id="id_div_calls_count">
                        <div class="col-md-3 col-indigo" ><p class="h2_count">0 </p><p class="h2_title">Calls</p></div>
                        <div class="col-md-3 col-teal"><p class="h2_count">0 </p><p class="h2_title">Answered</p></div>
                        <div class="col-md-3 col-orange" ><p class="h2_count">0 </p><p class="h2_title">Ringing</p></div>
                        <div class="col-md-3 col-deep-purple"><p class="h2_count">0 </p><p class="h2_title">Progress</p></div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <!-- graph-->
                        <div class="col-md-4 col-sm-4">
                            <div class="col-md-3 col-indigo" ><p class="h2_count" id="customers_status">0/0 </p><p class="h2_title">Customers</p></div>
                        </div>
                        <div class="col-md-4 col-sm-4" id="incoming_calls_bar_chart">
                        ...
                        <div class="col-md-4 col-sm-4" id="outgoing_calls_bar_chart">
                            <span class="sparkline_two" >
                                <canvas style="display: inline-block;  width: 196px; height: 50px;" ></canvas>
                            </span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card clearfix">
                        <div class="body clearfix">
                            <div class="col-md-4"  id="id_outgoing_calls">
                                <table class="table table-condensed" style="width:100%">
                                    <tr>
                                        <td  align="center"><h4>Traffic Usage</h4></td></tr>
                                    <tr>                                 
                                        <td id="id_traffic_usage">
                            ...
                            <div class="col-md-4"  id="id_incoming_calls">
                                <table class="table table-condensed" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="table table-condensed tile_info">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" height="200">
                    <div class="card ">
                        <div class="header bg-teal"><h2>Customer</h2></div>
                        <div class="body ">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="header bg-cyan"><h2>Carrier</h2></div>
                        <div class="body ">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="header bg-lime"><h2>Destination</h2></div>
                        <div class="body">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">     
                <div class="col-md-6 col-sm-12 col-xs-12">                        
                    <table class="table  table-bordered" >                                
                        <thead>
                            <tr class="headings">
                                <th colspan="6" class="text-center">Recent Customer Calls</th>
                            </tr>
                            <tr class="headings">
                                <th>Customer</th>
                                <th>Calls</th>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <table class="table table-bordered" >                    
                        <thead>
                            <tr class="headings">
                                <th colspan="6" class="text-center">Recent Carrier Calls</th>
                            </tr>                    
                            <tr class="headings">
                                <th>Carrier</th>
                                <th>Calls</th>
...
<script>
    ...
    function destination_wise_calls(value)
    {
        ...
        {
        //    call_str += '<li><div class="media-body"><b>' + single_array.customer_destination + '</b><p><strong>' + single_array.total_calls + 
//'</strong> [<span style="color:#089378;">' + single_array.answering + '</span> / <span style="color:#e74c3c;">' + single_array.ringing + '</span>] </p></div></li>';



call_str += '<li>' +
                            '<b><span class="text-left col-md-6">' +  single_array.customer_destination + '<b></span>'+
                           
                            ' <span class="text-left col-md-6"> <strong>' + single_array.total_calls + '</strong> [<span style="color:#089378;">' + single_array.answering + '</span> / <span style="color:#e74c3c;">' +  single_array.ringing + '</span>]</span>' +
                            '</li>';
    ...
    $(document).ready(function () {
        ...
        $.dataBox = function (id, value) {
            ...
            $.each(value, function (k, v) {
                ...
                if (id == 'carrierList')
                {
                    str_new += '<li >' +
                            '<b>' + v.name + '</b>' +
                            '<p class=""><span class="text-left col-md-6">' + v.ip + '</span>' +
                 ...
                 //   str_new += '<li class="media event" style="margin-bottom: 2px;"><div class="media-body">' +
                  //          '<b>' + v.name + ' [' + v.type + ']</b>' +
                   //         '<p class=""><span class="text-left col-md-6">' + v.ip + '</span>' +
                   //         ' <span class="text-right col-md-6"> <strong>' + v.total_calls + '</strong> [<span style="color:#089378;">' + v.answer + '</span> / <span style="color:#e74c3c;">' + (v.total_calls - v.answer) + '</span>]</span></p>' +
                   //         '</div></li>';
        ...
        $.show_usage = function (value) {
            ...
            var usage_str = '';
            usage_str = '<tr ><th>&nbsp;</th><th class="text-center">ZAR</th><th class="text-center">GBP</th><th class="text-center">INR</th><th class="text-center">USD</th><th class="text-center">EURO</th></tr>';
            ...
            if (value.length > 0)
            {
                value.forEach(function (single_array) {
                    ...
                    if (asr < 1)
                        ...
                        tr_class = '';
                    customer_str += '<tr class="' + tr_class + '"><td>' + single_array.account_id + '</td><td>' + single_array.tot_answered + ' / ' + single_array.tot_calls + '</td><td>' + single_array.asr + '</td><td>' + single_array.acd + '</td><td>' + single_array.tot_cost + '</td></tr>';
        ...
        $.show_carrier_call_stat = function (value) {
            ...
            if (value.length > 0)
            {
                value.forEach(function (single_array) {
                    ...
                    carrier_str += '<tr class="' + tr_class + '"><td>' + single_array.carrier_id + '</td><td>' + single_array.tot_answered + ' / ' + single_array.tot_calls + '</td><td>' + single_array.asr + '</td><td>' + single_array.acd + '</td><td>' + single_array.tot_cost + '</td></tr>';
        ...
        function customers_status() {
            var target_url = BASE_URL + "reports/customers_status";
            $.get(target_url, function (data, status) {
                $('#customers_status').html(data);
                 //   alert("Data: " + data + "\nStatus: " + status);
              });
        }
        ...
        {
            var target_url = BASE_URL + "reports/usage";
            $.get(target_url, function (data, status) {
                $('#id_traffic_usage').html(data);
                 //   alert("Data: " + data + "\nStatus: " + status);
              });
