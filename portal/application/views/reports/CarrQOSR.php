...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<div class="btn-group pull-right">                    
			...
			{
				echo '<li><a href="'.base_url().'reports/analytics_carrier/export/'.param_encrypt($export_format).'">'.strtoupper($export_format).'</a></li>';
			}							
			?>                            
			</ul>
	</div> 
	<?php endif;?>
        <div class="x_title">
            <h2>Total Records : <?php if (isset($listing_count)) echo $listing_count; else echo '0'; ?></h2>
            <div class="clearfix"></div>
        </div>	
        <div class="x_content">
                ...
                <table id="analytics" class="table table-striped jambo_table bulk_action table-bordered">
                    ...
                    <tbody>
						...
						$currency_abbr = function($id) use ($currency_data){
							...
							if($key === false) return '';
							else return $currency_data[$key]['name'];			
						};
