    ...
    <div class="x_panel">
        <div class="x_title">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <?php if (!check_logged_user_group(array('CUSTOMER')) && $searched_account_id != '') { ?>
                    <li><a href="<?php echo site_url('billing/sdr/' . param_encrypt($searched_account_id)) ?>"><input type="button" value="Add / Edit Unbill Usage " name="add_link" class="btn btn-primary"></a></li>
                <?php } ?>
            </ul>
