...
$range = explode(' - ',$_SESSION['search_sales_monthly_data']['s_cdr_record_date']);
...
for($i=1;$i<35;$i++)
{
	...
	$day_formatted =  date('m-Y', $day_stamp);
...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Reporting : Sales Monthly Summary</h2>
    ...
    <div class="x_content">
      <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="">
        ...
        <div class="form-group">        
           ...
           <select name="account_manager" id="account_manager" class="form-control" tabindex="<?php echo $tab_index++;?>">
                   <option value="">Select</option>                    
					...
					if(isset($ac_mngrs_data['result']) && count($ac_mngrs_data['result']) > 0)
					{
						...
						{
							$selected = ' ';
							if($ac_mngr_array['user_access_id_name'] == $_SESSION['search_sales_monthly_data']['s_account_manager']) 
          ...
          <div class="col-md-2 col-sm-9 col-xs-12">
            <input type="text" class="form-control data-search-field" name="account_id" id="account_id" value="<?php echo $_SESSION['search_sales_monthly_data']['s_account_id'];?>">
          </div>
