...
<script>
    ...
    function destination_wise_calls(value)
    {
        ...
        {
            call_str += '<li class="media event" style="margin-bottom: 2px;"><div class="media-body"><b>' + single_array.customer_destination + '</b><p><strong>' + single_array.total_calls + '</strong> [<span style="color:#089378;">' + single_array.answering + '</span> / <span style="color:#e74c3c;">' + single_array.ringing + '</span>] </p></div></li>';
        });
