    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card clearfix">
                <div class="header"><h2 class="text-center">SNAPSHOT</h2>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.loadAnalytics = function () {
            ...
            var target_url = BASE_URL + "reports/monin_data_reseller/" + get_string;
        ...
        function loadTraffic()
        {
            ...
            //console.log("loadtraffic loadtraffic loadtraffic loadtraffic");
