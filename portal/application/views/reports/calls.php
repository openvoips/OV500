    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo base_url(); ?>reports/Calls">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-3 col-xs-12 ">
                                <select class="form-control data-search-field" id="customer_type" name="customer_type">
                                    <?php if ($get_logged_customer_level == 0) { ?>
                                        <option value="U"  <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'U') echo 'selected'; ?>>Customer</option>
                                        <option value="R1" <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'R1') echo 'selected'; ?>>Reseller</option>
                                    <?php } ?>
                                    <?php if ($get_logged_customer_level == 1) { ?>
                                        <option value="U"  <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'U') echo 'selected'; ?>>Customer</option>
                                        <option value="R2" <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'R2') echo 'selected'; ?>>Reseller </option>
                                    <?php } ?>
                                    <?php if ($get_logged_customer_level == 2) { ?>
                                        <option value="U"  <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'U') echo 'selected'; ?>>Customer</option>
                                        <option value="R3" <?php if ($_SESSION['search_cdr_data']['s_cdr_customer_type'] == 'R3') echo 'selected'; ?>>Reseller</option>
                                    <?php } ?>
                        ...
                        <div class="form-group">                         
                            <?php if (isset($all_field_array['C-DST'])): ?>
                                <label class="control-label col-md-2 col-sm-3 col-xs-12">Callee Number as sent to Carrier</label>
                                <div class="col-md-2 col-sm-3 col-xs-12">
                            ...
                            <?php if (isset($all_field_array['C-CLI'])): ?>	
                                <label class="control-label col-md-2 col-sm-3 col-xs-12">Caller Number as sent to Carrier</label>
                                <div class="col-md-2 col-sm-3 col-xs-12">
                ...
                <div class="body">
                    <div class="row">  
                        <?php dispay_pagination_row_bsd($total_records, $_SESSION['search_cdr_data']['s_no_of_records'], $pagination);
                        ?>                    
                    </div>     
                                ...
                                if (isset($listing_count) && $listing_count > 0) {
                                    foreach ($listing_data as $listing_row) {
                                        ...
                                        foreach ($all_field_array as $field_name => $field_lebel) {
                                            ...
                                            } elseif ($field_name == 'disposition_cause') {

                                                echo wordwrap($listing_row[$field_name], 25, "<br>\n", false);
...
<script>
    $(document).ready(function () {
        ...
        showDatatable('analytics', [], [7, "desc"]);
