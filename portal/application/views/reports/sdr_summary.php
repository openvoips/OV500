                                    ...
                                    foreach ($all_date_array as $date_value) {
                                        ...
                                        if (isset($data['result'][$account_id][$date_value])) {
                                            ...
                                            if ($parameter_key == 'profit') {
                                                $data['result'][$account_id][$date_value][$parameter_key]['sum_total_cost'] = $data['result'][$account_id][$date_value]['call_cost']['sum_total_cost'] - $data['result'][$account_id][$date_value]['call_cost']['sum_total_seller_cost'] + $data['result'][$account_id][$date_value]['other_charges']['sum_total_cost'] - $data['result'][$account_id][$date_value]['other_charges']['sum_total_seller_cost'];
                                            }
