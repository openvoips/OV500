...
<div class="col-md-12 col-sm-6 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content"> 
            <form class="block-content form-horizontal " id="search_form" name="search_form"  method="post" action="<?php echo base_url(); ?>payment/trace">
                ...
                <table class="table table-striped jambo_table bulk_action table-bordered" id="table-sort">
                    ...
                    <tbody>
                        ...
                        if (count($trace_data['result']) > 0) {
                            ...
                            <td> <a href="<?php echo base_url(); ?>payment/trace_details/<?php echo param_encrypt($rec['order_id']); ?>" title="Order Details"><u><?php echo $rec['order_id']; ?></u></a>
                            </td>
