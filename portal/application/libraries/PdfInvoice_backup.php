...
{ 
	...
	function __construct() { parent::__construct(); //$this->original_lMargin=10;	
	}
	...
	public function Header() {
		...
		if ($this->header_xobjid === false) {
			...
			$search_tbl = '<table cellspacing="0" cellpadding="05" border="0" >';				
			$search_tbl .= '<tr>
							<td width="40%">'.$this->header_text1.'</td>
							<td width="20%">&nbsp;</td>
							<td width="40%"><i>'.$this->header_text3.'</i></td></tr>';	
			$search_tbl .= '</table>';
