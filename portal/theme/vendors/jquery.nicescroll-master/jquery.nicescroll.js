...
(function (factory) {
    ...
    var getBrowserDetection = function () {
        ...
        d.hastransition = ("transition" in _style) || (function () {
            ...
            if (d.ischrome26)
                d.prefixstyle = prefix[1];  // always use prefix
    ...
    var NiceScrollClass = function (myopt, me) {
        ...
        this.init = function () {
            ...
            if (cap.isandroid && !("hidden" in _doc))
                return true; // Android 3- SORRY, DO NOT WORK!
            ...
            if (!self.ispage || !cap.isieold) {
                ...
                if (opt.horizrailenabled) {
                    ...
                    if (cap.isieold)
                        cursor.css('overflow', 'hidden');  //IE6 horiz scrollbar issue
                ...
                if (self.ispage) {
                    ...
                    if (opt.disableoutline) {
                        ...
                        if (cap.iswebkit)
                            self.win.css('outline', 'none');  // Webkit outline
                    }
...
//        if (!cap.cantouch && !opt.emulatetouch) {
        ...
        this.onmousewheelhr = function (e) {
            ...
            self.checkarea = nw;
            if (self.nativescrollingarea)
                return true; // this is not my business
            if (self.railslocked)
                return self.cancelEvent(e);
